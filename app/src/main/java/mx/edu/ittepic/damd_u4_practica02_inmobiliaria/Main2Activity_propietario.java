...
public class Main2Activity_propietario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2_propietario);

        regrear = findViewById(R.id.back);
        ...
        regrear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent otraVentana = new Intent(Main2Activity_propietario.this, MainActivity.class);
        ...
        insertar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (identificacion.length() == 0 || nombre.length()==0 || domicilio.length() == 0 || telefono.length() == 0){
                    Toast.makeText(Main2Activity_propietario.this, "Favor de llenar todos los campos", Toast.LENGTH_LONG).show();
                }else{
                    guardarDatos();
                }
        ...
        alerta.setTitle("ATENCION").setMessage(mensaje).setView(pidoID).setPositiveButton(mensajeBoton, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (pidoID.getText().toString().isEmpty()){
                    Toast.makeText(Main2Activity_propietario.this, "DEBES ESCRIBIR VALOR", Toast.LENGTH_LONG).show();
                    return;
                }
