...
public class Main2Activity_inmueble extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main2_inmueble);
        ...
        regrear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent otraVentana = new Intent(Main2Activity_inmueble.this, MainActivity.class);
        ...
        insertar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (identificacion.length() == 0 || domicilio.length()==0 || precioVenta.length() == 0 || precioRenta.length() == 0 || fechaTransaccion.length() == 0){
                    Toast.makeText(Main2Activity_inmueble.this, "Favor de llenar todos los campos", Toast.LENGTH_LONG).show();
                }else{
                    guardarDatos();
                }
            }
        ...
        alerta.setTitle("ATENCION").setMessage(mensaje).setView(pidoID).setPositiveButton(mensajeBoton, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (pidoID.getText().toString().isEmpty()){
                    Toast.makeText(Main2Activity_inmueble.this, "DEBES ESCRIBIR VALOR", Toast.LENGTH_LONG).show();
                    return;
                }
